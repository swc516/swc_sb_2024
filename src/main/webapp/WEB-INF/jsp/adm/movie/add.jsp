...
<script>
	...
	function MovieAdd__submitForm(form) {
		...
		form.file__movie__0__extra__moviePosterImg__1.value = form.file__movie__0__extra__moviePosterImg__1.value.trim();

		if (form.file__movie__0__extra__moviePosterImg__1.value.length == 0) {
			alert('영화포스터를 추가해주세요');
			form.file__movie__0__extra__moviePosterImg__1.focus();
			return;
		}
